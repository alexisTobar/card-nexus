    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="bg-slate-900 border border-white/10 w-full max-w-md rounded-3xl overflow-hidden shadow-2xl">
        <div className="p-6 border-b border-white/5 flex justify-between items-center bg-slate-800/50">
          <h3 className="font-black uppercase italic tracking-tighter">Añadir a mi Colección</h3>
          <button onClick={onClose} className="text-slate-500 hover:text-white"><X size={20} /></button>
        </div>

        <div className="p-8 space-y-6">
          <div className="flex gap-4 items-center mb-4">
             <img src={`${card.image}/low.webp`} className="w-20 rounded-lg shadow-lg" alt="Preview" />
             <div>
                <p className="text-xs font-bold text-blue-400 uppercase tracking-widest">{card.set.name}</p>
                <h4 className="font-black text-xl leading-none uppercase italic">{card.name}</h4>
             </div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-slate-950 border border-white/10 rounded-xl py-3 px-10 outline-none focus:border-blue-500 transition-all" 
                  placeholder="0.00"
                />
            ...
            <div>
              ...
              <div className="relative">
                <textarea 
                  ...
                  className="w-full bg-slate-950 border border-white/10 rounded-xl py-3 px-10 outline-none focus:border-blue-500 transition-all min-h-[80px]" 
          ...
          <button 
            ...
            className="w-full bg-blue-600 hover:bg-blue-500 py-4 rounded-2xl font-black uppercase text-sm tracking-widest shadow-lg shadow-blue-500/20 transition-all flex items-center justify-center gap-2"
          >
